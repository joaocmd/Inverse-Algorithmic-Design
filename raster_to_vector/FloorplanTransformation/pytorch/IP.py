    ...
    if LpStatus[model.status] == 'Optimal':
      ...
      with open(output_prefix + 'floorplan.txt', 'w') as result_file:
        ...
        for wallIndex, wall in enumerate(filteredWallLines):
          ...
          result['walls'].append(((float(point_1[0]), float(point_1[1])), (float(point_2[0]), float(point_2[1])), filteredWallLabels[wallIndex][0], filteredWallLabels[wallIndex][1]))
        ...
        for doorIndex, door in enumerate(filteredDoorLines):
          ...
          result['doors'].append(((float(point_1[0]), float(point_1[1])), (float(point_2[0]), float(point_2[1]))))
        ...
        for iconIndex, icon in enumerate(filteredIcons):
          ...
          result_file.write('1\t')
          result_file.write('1\n')
          result['icons'].append(((float(point_1[0]), float(point_1[1])), (float(point_2[0]), float(point_2[1])), iconNumberNameMap[filteredIconTypes[iconIndex]]))
