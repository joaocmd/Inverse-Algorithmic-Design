...
thickwall([p32, p33])
thickwall([p33, p34]; parts=[window(0.25, -0.25)])
thickwall([p34, p48]; parts=[window(0, 0)])
thinwall([p35, p37]; parts=[window(0, 0)])
...
thinwall([p45, p54])
thinwall([p46, p57])
thickwall([p47, p48]; parts=[window(0.25, -0.25)])
thickwall([p47, p59])
thinwall([p48, p61])
thinwall([p49, p50])
thinwall([p49, p75])
...
thinwall([p54, p55])
thinwall([p57, p58])
thinwall([p57, p62]; parts=[door(0.35, 0.35)])
thinwall([p58, p59]; parts=[door(0.34, 0.46)])
thinwall([p58, p63])
thinwall([p62, p63])
...
thickwall([p90, p91])
thickwall([p90, p95])
thickwall([p91, p92]; parts=[door(0.25, -0.25)])
thickwall([p92, p93]; parts=[window(0.43, 0.65)])
thickwall([p93, p94])
thickwall([p95, p96])
KhepriAutoCAD.curtain_wall([p30, p43])
