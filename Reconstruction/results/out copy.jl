...
thinwall(wallpath; parts=[]) = wall(wallpath, 0.13636363636363635; parts=parts)
...
thinwall([p7, p8])
thickwall([p7, p15]; parts=[door(0.27, 1.25)])
thinwall([p8, p9]; parts=[door(0.25, 0.71)])
thinwall([p8, p16]; parts=[door(0.68, 0.79)])
thinwall([p9, p10]; parts=[door(1.16, 0.71)])
thinwall([p10, p11]; parts=[door(0.22, 0.71)])
thinwall([p11, p12])
thinwall([p11, p18]; parts=[door(0.82, 0.71)])
...
thinwall([p17, p19])
thinwall([p18, p20])
thinwall([p19, p20]; parts=[door(0.82, 0.55)])
thinwall([p19, p26]; parts=[door(0.19, 0.71)])
thinwall([p20, p21])
...
thickwall([p27, p35]; parts=[window(0.5, 1.09), door(2.84, 0.79)])
thickwall([p30, p31]; parts=[window(0.21, 0.7)])
thickwall([p31, p42]; parts=[window(2.56, 1.28)])
thinwall([p32, p33])
thinwall([p33, p34])
thinwall([p33, p39])
thinwall([p34, p35]; parts=[door(0.42, 0.79)])
thinwall([p34, p41]; parts=[door(0.47, 0.55)])
...
thinwall([p40, p41])
thinwall([p40, p45])
thickwall([p42, p43]; parts=[window(0.24, 2.73), door(3.57, 0.71)])
thickwall([p43, p44]; parts=[window(0.38, 0.49)])
thinwall([p44, p45]; parts=[door(0.34, 0.55)])
thinwall([p44, p50]; parts=[window(0.38, 0.49)])
thinwall([p45, p46])
thinwall([p46, p51]; parts=[door(0.21, 0.71)])
thickwall([p50, p51])
thickwall([p51, p52]; parts=[door(0.36, 0.79)])
