...
curtain_wall([p44, p45])
curtain_wall([p44, p52, p90])
curtain_wall([p45, p48])
thinwall([p46, p55])
thinwall([p47, p58])
curtain_wall([p48, p49])
thinwall([p48, p60])
thinwall([p49, p62])
thinwall([p50, p51])
thinwall([p50, p76])
...
thinwall([p58, p59])
thinwall([p58, p63])
thinwall([p59, p60]; parts=[door(0.76, 0.98)])
thinwall([p59, p64])
thinwall([p63, p64])
...
thinwall([p69, p79])
thinwall([p71, p72])
thinwall([p72, p73]; parts=[door(0.7, 0.79)])
curtain_wall([p73, p74])
curtain_wall([p73, p95])
curtain_wall([p74, p75])
thickwall([p75, p76])
thickwall([p76, p77])
thinwall([p78, p79])
thinwall([p78, p80])
...
thinwall([p87, p93])
thinwall([p88, p94])
curtain_wall([p90, p91])
thinwall([p91, p92])
thickwall([p91, p96])
thinwall([p92, p93]; parts=[door(0.92, 0.79)])
