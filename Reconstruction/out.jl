...
wall9 = mywall([p5, p12], 2.9, parts=[mydoor(1.0, 50.8)])
wall10 = mywall([p6, p7], 2.9, parts=[mydoor(1.0, 33.6)])
wall11 = mywall([p6, p13], 2.9, parts=[mydoor(2.6, 44.9)])
wall12 = mywall([p7, p8], 2.9, parts=[mydoor(4.25, 42.3)])
wall13 = mywall([p8, p9], 2.9, parts=[mydoor(0.9, 42.3)])
wall14 = mywall([p9, p10], 1.05)
wall15 = mywall([p9, p15], 2.9, parts=[mydoor(3.0, 42.3)])
...
wall23 = mywall([p16, p17], 2.9, parts=[mydoor(3.1, 17.1)])
wall24 = mywall([p16, p22], 2.9, parts=[mydoor(0.81, 33.6)])
...
wall33 = mywall([p24, p30], 1.8, parts=[mywindow(1.8, 3.75), mydoor(10.4, 44.9)])
...
wall38 = mywall([p29, p30], 1.8, parts=[mydoor(2.1, 42.3)])
wall39 = mywall([p29, p34], 1.05, parts=[mydoor(1.7, 25.97)])
...
wall46 = mywall([p35, p36], 2.9, parts=[mywindow(0.9, 9.9), mydoor(13.1, 42.3)])
wall47 = mywall([p36, p37], 0.2, parts=[mywindow(1.4, 1.7)])
wall48 = mywall([p37, p38], 1.8, parts=[mydoor(1.45, 4.7)])
wall49 = mywall([p37, p40], 1.8, parts=[mywindow(1.4, 1.4)])
wall50 = mywall([p38, p39], 2.9)
wall51 = mywall([p39, p41], 2.9, parts=[mydoor(0.71, 42.3)])
wall52 = mywall([p40, p41], 1.8)
wall53 = mywall([p41, p42], 2.9, parts=[mydoor(1.8, 45.4)])
